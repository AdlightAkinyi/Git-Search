...
/* harmony import */ var _ngx_progressbar_core__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ngx-progressbar/core */ "./node_modules/@ngx-progressbar/core/esm5/ngx-progressbar-core.js");
/* harmony import */ var _ngx_progressbar_http_client__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @ngx-progressbar/http-client */ "./node_modules/@ngx-progressbar/http-client/esm5/ngx-progressbar-http-client.js");
...
var ReopsitoriesComponent = /** @class */ (function () {
    function ReopsitoriesComponent(repoService) {
        this.repoService = repoService;
    }
    ReopsitoriesComponent.prototype.repoSearch = function (searchName) {
        var _this = this;
        this.repoService.getReopos(searchName).then(function (results) {
            _this.repo = _this.repoService.allRepos;
            console.log(_this.repo);
        }, function (error) {
            console.log(error);
        });
    };
    ReopsitoriesComponent.prototype.ngOnInit = function () {
        this.repoSearch('Owiti-Charles');
    };
    ReopsitoriesComponent.ctorParameters = function () { return [
...
var Repos = /** @class */ (function () {
    function Repos(name, html_url, description, created_at, forks, watchers_count, language) {
        this.name = name;
    ...
    Repos.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: Date },
...
var User = /** @class */ (function () {
    function User(url, login, html_url, location, public_repos, followers, following, avatar_url, created_at) {
        this.url = url;
        this.login = login;
        this.html_url = html_url;
...
var UsersComponent = /** @class */ (function () {
    function UsersComponent(myService, repoService) {
        this.myService = myService;
        this.repoService = repoService;
    }
    UsersComponent.prototype.searchs = function (searchName) {
        var _this = this;
        this.myService.searchUSer(searchName).then(function (success) {
            _this.user = _this.myService.foundUser;
        }, function (error) {
            console.log(error);
        });
        this.repoService.getReopos(searchName).then(function (results) {
...
var UserserviceService = /** @class */ (function () {
    ...
    UserserviceService.prototype.searchUSer = function (searchName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get('https://api.github.com/users/' + searchName + '?access_token=' + src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_5__["environment"].apiKey).toPromise().then(function (result) {
    ...
    UserserviceService.prototype.getReopos = function (searchName) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.http.get('https://api.github.com/users/' + searchName + "/repos?order=created&sort=asc?access_token=" + src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_5__["environment"].apiKey).toPromise().then(function (results) {
                _this.allRepos = results;
                resolve();
            }, function (error) {
                console.log(error);
                reject();
